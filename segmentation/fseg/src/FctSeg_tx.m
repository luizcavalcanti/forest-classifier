function [SegLab]=FctSeg_tx(Ig,ws,segn,NC)
% Compute segment labels for images with heavy texture
...
%                  May need to be tuned if the choice of filters are changed.
...
Y2=reshape(Y1,dimn,N1,N2);
tmp=SHedge_1s(ws,2,Y2);
