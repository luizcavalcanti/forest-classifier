...
%
%     default parameters:
%     omega = 1000; For segment number estimation based on singular values
...
sh_mx1=SHcomp_givenRange(N1,N2,bn,ws,Ig,single(IgRg));
sh_mx2=SHcomp_givenRange(N1,N2,bn,ws1,Ig,single(IgRg));
